...
namespace Devster\CmsBundle\KnpPager\Event\Subscriber\Doctrine\ORM;
        ...
        if ($event->target instanceof Query) {
            ...
            if (null !== $sortField && $this->argumentAccess->has($sortField)) {
                ...
                foreach (explode('+', $sortFieldParameterNames) as $sortFieldParameterName) {
                    $sortedFields[$sortFieldParameterName] = $dir;
                ...
                $event->setCustomPaginationParameter('sortedFields', $sortedFields);
